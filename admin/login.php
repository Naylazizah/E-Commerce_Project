...
<body>
    <section class="vh-100" style="background-color: #B0C4DE;">
                    ...
                    <div class="card" style="border-radius: 1rem;">
                        <div class="row g-0">
                            <div class="col-md-6 col-lg-5 d-none d-md-block">
                                <img src="assets/img/logosembako.png    " alt="login form" 
                                ...
                                <div class="card-body p-4 p-lg-4 text-black">
                                    ...
                                    <form data-parsley-validate="" novalidate="" onsubmit="return false">
                                        ...
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <span class="h1 fw-bold mb-0">sembakoberkah</span>
                                        </div>
                                        ...
                                        <p class="mb-2 pb-lg-1" style="color: #393f81;">Don't have an account? <a
                                                href="register2.php" style="color: #393f81;">Register here</a></p>
                                        ...
                                        <div class="toast-container position-fixed bottom-0 end-0 p-3">
                                            <div id="liveToast" class="toast" role="alert" aria-live="assertive"
                                                ...
                                                <div class="toast-header bg-info">
                                                    ...
                                                    <strong class="me-auto text-black">Admin Nayla</strong>
